...
\vspace{4mm} This is now shown clearly in figures 2 and 4. (Figure 5 is a zoom around $\lambda = 1$ and does not show the origin). In addition, internal mode eigenvalues are shown on all figures, and markers have been updated for improved readability.
